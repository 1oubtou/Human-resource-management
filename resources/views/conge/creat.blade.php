				...
				<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-2 row-cols-lg-2">
					<div class="col">
						<div class="fv-row mb-7">
							...
							<input type="date" class="form-control date" name="date_debut" value="{{ old('date_debut') }}" required  />
							@error('date_debut')
								<span class="text-danger">{{ $message }}</span>
							@enderror
						</div>
					...
					<div class="col">
						<div class="fv-row mb-7">
							...
							<input type="date" class="form-control date" name="date_fin" value="{{ old('date_fin') }}" maxlength="10" required  />
							@error('date_fin')
								<span class="text-danger">{{ $message }}</span>
							@enderror
						</div>
